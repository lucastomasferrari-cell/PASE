...
export const APPS: AppDef[] = [
  { key: 'pase', nombre: 'PASE', emoji: '', desc: 'Back-office: EERR, RRHH, Caja, Conciliación, Facturas.', paraQuien: 'Dueño, admin, contadora', url: 'https://pase.comanda.lat', tier: 'administrativa' },
  { key: 'comanda', nombre: 'COMANDA', emoji: '', desc: 'POS: ventas, salón, KDS, tienda online.', paraQuien: 'Cajeros, mozos, cocina', url: 'https://pos.comanda.lat', tier: 'operativa' },
  { key: 'mesa', nombre: 'MESA', emoji: '', desc: 'Reservas, plano del salón, comensales.', paraQuien: 'Encargados de reservas, anfitriones', url: 'https://reservas.comanda.lat/admin', tier: 'operativa' },
  { key: 'habitue', nombre: 'Habitué', emoji: '', desc: 'CRM y marketing: segmentos, campañas, fidelidad.', paraQuien: 'Marketing, dueño', url: 'https://habitue.comanda.lat/admin', tier: 'administrativa' },
  { key: 'instagram', nombre: 'Instagram bot', emoji: '', desc: 'Bot de Instagram: respuestas automáticas y campañas.', paraQuien: 'Marketing, dueño', url: 'https://bot.comanda.lat', tier: 'administrativa' },
