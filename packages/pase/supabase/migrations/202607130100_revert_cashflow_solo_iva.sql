-- Revert del filtro solo_iva en el cashflow (feature descartada 13-jul).
-- Re-crea cashflow_pyl_mes + cashflow_puente_mes SIN el filtro solo_iva
-- (vuelve a la version 202607120200, con el fix de aguinaldo intacto).
-- 202607130100_revert_cashflow_solo_iva.sql
-- Aguinaldos/vacaciones en Sueldos del cashflow (espejo del fix del EERR, commit dcab264b).
