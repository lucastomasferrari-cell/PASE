-- 202606130400_pagar_sueldo_recalculo_server.sql
--
...
BEGIN
  ...
  -- Aguinaldo: total_a_pagar / 12. Usa el total CANÓNICO (v_total_a_pagar ya es
  -- ROUND(v_liq.total_a_pagar) y v_liq.total_a_pagar salió de v_canon).
  IF v_completa THEN
