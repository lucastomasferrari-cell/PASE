-- 202606181700_concil_mp_multifactura_detalle.sql
-- Conciliación MP (módulo viejo, real-time): al conciliar un egreso MP contra
-- varias facturas, el movimiento decía 'Pago a N facturas vía MP' (genérico,
-- no decía proveedor ni qué facturas). Ahora arma el detalle con el proveedor
-- + los N° de factura, igual que un pago normal. Solo cambia el texto del
-- detalle (la lógica de plata/saldos no se toca).
