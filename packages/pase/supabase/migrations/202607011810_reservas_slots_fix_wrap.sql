-- Fix: el loop de franjas usaba aritmética de TIME que da la vuelta a
-- medianoche (23:30+30min=00:00) → metía franjas de madrugada. Se reemplaza
-- por un contador de minutos entero (sin wrap).
...
DECLARE
  ...
  v_cur INTEGER; v_fin INTEGER; v_hhmm TEXT;
BEGIN
  ...
  IF v_fin <= v_cur THEN v_fin := 23 * 60 + 30; END IF;   -- guard
