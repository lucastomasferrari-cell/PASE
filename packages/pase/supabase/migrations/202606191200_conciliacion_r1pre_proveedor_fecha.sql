-- Pieza 1 del proyecto "calidad del cruce" (Lucas 19-jun).
-- Agrega el paso R1-pre a fn_cruzar_extracto_mp: para transferencias con
-- proveedor conocido por alias, matchea primero el pago DE ESE proveedor y,
-- si hay varios, el de fecha mas cercana. Aditivo: las filas sin alias siguen
-- por R1/R2/R3 igual que antes. Spec: docs/superpowers/specs/2026-06-18-cruce-calidad-emparejamiento-design.md
-- Verificado antes/despues contra borradores reales (locales 1,2,3): +2 verdes,
-- 0 regresiones verde->peor.
