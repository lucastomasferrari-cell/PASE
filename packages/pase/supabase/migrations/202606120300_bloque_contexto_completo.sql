-- 202606120300_bloque_contexto_completo.sql
-- Lucas: "necesito que igual si no coincide todo el bloque las ponga ahi
-- porque sino no tengo el registro completo de lo que paso el mes para
-- poder encontrar el error". Cuando un bloque tiene diferencia, incluye
-- también las transferencias y pagos que YA matchearon individualmente
-- con ese proveedor, como contexto informativo ("ya_matcheados_ext" y
-- "ya_matcheados_pase"). El frontend los muestra en gris para tener
-- la foto completa sin romper los matches individuales.
