-- Intervalo de turno configurable por local (para locales con turnos fijos,
-- ej. Maneki: turnos de 2h → grilla con 20:00 y 22:00, no cada 30 min).
ALTER TABLE comanda_local_settings
  ADD COLUMN IF NOT EXISTS reservas_slot_min INTEGER NOT NULL DEFAULT 30;
