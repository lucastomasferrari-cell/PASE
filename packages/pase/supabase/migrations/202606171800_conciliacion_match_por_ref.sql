-- 202606171800_conciliacion_match_por_ref.sql
-- Match por referencia del extracto en el cruce (R0, antes del match por monto).
-- Los movs creados desde la conciliación llevan la ref en el detalle → se
-- emparejan con su línea exacta, desambiguando montos repetidos (caso: 2x
-- $213.062 UNION + 2x $340.000 transferencias que figuraban como "sobran").
