-- ═══════════════════════════════════════════════════════════════════════════
-- F1.2c — fn_abrir_venta_comanda acepta p_cliente_id (vinculo CRM)
-- ═══════════════════════════════════════════════════════════════════════════
-- Cuando el cajero elige un cliente del CRM en NuevoPedidoDialog, pasamos
-- el cliente_id directamente. Al cobrar la venta, el trigger
-- fn_trg_actualizar_cliente_counters actualiza total_pedidos/gastado.

DROP FUNCTION IF EXISTS fn_abrir_venta_comanda(INTEGER, TEXT, INTEGER, BIGINT, UUID, UUID, TEXT, TEXT, TEXT, INTEGER, TEXT, TEXT, TEXT, TIMESTAMPTZ);
