...
export function Sidebar({ user, onLogout, locales, localActivo, setLocalActivo, tenant, tenantOverride, onClearOverride }: SidebarProps) {
  ...
  const nav = [
    ...
    // Observatorios temporales (2026-05-14) — 2 pruebas paralelas.
    {slug:"prueba_conciliacion_1",path:"/herramientas/prueba-conciliacion-1",label:"Prueba Conc. 1",sec:"Herramientas",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8a4 4 0 0 1 8 0"/><path d="M1 8a6 6 0 0 1 12 0"/><circle cx="7" cy="11" r="1.2" fill="currentColor"/></svg>`},
    {slug:"prueba_conciliacion_2",path:"/herramientas/prueba-conciliacion-2",label:"Prueba Conc. 2",sec:"Herramientas",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8a4 4 0 0 1 8 0"/><path d="M1 8a6 6 0 0 1 12 0"/><circle cx="7" cy="11" r="1.2" fill="currentColor"/></svg>`},
