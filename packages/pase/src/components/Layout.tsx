...
.login-sub{font-size:10px;color:var(--pase-text-muted);margin-bottom:36px;margin-top:8px;letter-spacing:0.06em;text-transform: none;font-weight:400;text-align:center}
