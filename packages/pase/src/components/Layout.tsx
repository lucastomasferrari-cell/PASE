...
export function Sidebar({ user, locales, localActivo, setLocalActivo, tenant, tenantOverride, onClearOverride }: SidebarProps) {
  ...
  const nav: Array<{ slug: string; path: string; label: string; sec: string; icon: string; altSlugs?: string[] }> = [
    ...
    {slug:"cmv",path:"/cmv",label:"Prime Cost",sec:"Operación",icon:`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 1.5v11"/><path d="M2.5 4.5h9"/><path d="M2.5 4.5 1 8h3z"/><path d="M11.5 4.5 10 8h3z"/><path d="M4.5 12.5h5"/></svg>`},
...
.sb-brand-icon{width:28px;height:28px;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:500;color:var(--pase-text);background:var(--pase-celeste-100);border-radius:8px;letter-spacing:-0.02em}
...
.sb-group-hd{display:flex;align-items:center;justify-content:space-between;width:100%;padding:10px 14px 4px;border:none;background:none;cursor:pointer;font-size:10px;letter-spacing:0.05em;text-transform: none;color:var(--pase-text-muted);font-weight:500;font-family:var(--pase-font);transition:color 0.15s}
...
.ph-row{display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:22px;gap:12px;flex-wrap:wrap;padding-right:44px}
...
.kpi-label{font-size:var(--pase-fs-sm);color:var(--pase-text-muted);margin-bottom:8px;font-weight:500;letter-spacing:0.03em;text-transform: none}
...
.field label{display:block;font-size:var(--pase-fs-xs);color:var(--pase-text-muted);margin-bottom:6px;font-weight:500;letter-spacing:0.03em;text-transform: none}
...
.login-card{position:relative;width:100%;max-width:448px;background:var(--pase-bg);border:0.5px solid var(--pase-border);border-radius:16px;padding:32px}
.login-brand{font-family:var(--pase-font);font-size:36px;font-weight:500;color:var(--pase-text);line-height:1;letter-spacing:-0.04em;text-align:center}
.login-sub{font-size:11px;color:var(--pase-text-muted);margin-bottom:28px;margin-top:8px;letter-spacing:0.06em;text-transform: none;font-weight:400;text-align:center}
...
.eerr-section-title{padding:10px 18px;font-size:var(--pase-fs-xs);color:var(--pase-text-muted);font-weight:500;border-top:0.5px solid var(--pase-border);background:var(--pase-bg-soft);letter-spacing:0.04em;text-transform: none}
...
.section-title{font-size:var(--pase-fs-xs);color:var(--pase-text-muted);font-weight:500;letter-spacing:0.04em;text-transform: none}
...
@media (max-width: 1024px) {
  ...
  .ph-row { flex-direction: column; gap: 8px; padding-right: 0; }
  .tabs { gap: 0; }
...
.pase-topbar{position:fixed;top:9px;right:16px;z-index:15;display:flex;align-items:center;gap:4px;padding:5px 7px;background:var(--pase-bg);border:0.5px solid var(--pase-border);border-radius:999px;box-shadow:0 2px 10px rgba(15,30,45,0.06)}
