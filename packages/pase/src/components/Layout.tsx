...
export function Sidebar({ user, onLogout, locales, localActivo, setLocalActivo, tenant, tenantOverride, onClearOverride }: SidebarProps) {
  ...
  const nav: Array<{ slug: string; path: string; label: string; sec: string; icon: string; altSlugs?: string[] }> = [
    ...
    {slug:"cmv",path:"/cmv",label:"CMV",sec:"Operación",icon:`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 1.5v11"/><path d="M2.5 4.5h9"/><path d="M2.5 4.5 1 8h3z"/><path d="M11.5 4.5 10 8h3z"/><path d="M4.5 12.5h5"/></svg>`},
