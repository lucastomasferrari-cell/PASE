...
export function UploadIcon({ size = 28, tone = "muted" }: IconProps) {
  return (
    <svg {...base(size, tone)} aria-hidden>
...
// ─── Folder / subir CSV ────────────────────────────────────────────────
export function FolderIcon({ size = 28, tone = "muted" }: IconProps) {
  return (
    <svg {...base(size, tone)} aria-hidden>
...
// ─── Document / archivo ────────────────────────────────────────────────
export function DocumentIcon({ size = 28, tone = "muted" }: IconProps) {
  return (
    <svg {...base(size, tone)} aria-hidden>
...
// ─── Alert / advertencia ───────────────────────────────────────────────
export function AlertIcon({ size = 28, tone = "muted" }: IconProps) {
  return (
    <svg {...base(size, tone)} aria-hidden>
