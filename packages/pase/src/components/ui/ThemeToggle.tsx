...
/** Toggle de tema — versión icon-only inline, sin wrapper.
 *  Vive dentro del sb-user-row (al lado del nombre del usuario en el
 *  sidebar). Antes era un botón con label en una card aparte; sprint v2
 *  cosmético lo simplifica a un ícono 28x28. */
