...
const MAP: Record<string, string> = {
  ...
  SOBREPAGO_EXCESIVO: "Estás pagando mucho más de lo que falta de este mes. Si la plata es de otro mes, pagala en ese mes; si hubo un aumento, actualizá el sueldo.",
