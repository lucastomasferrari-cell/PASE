...
// Correr (usa el sharp de comanda, que ya está instalado):
//   pnpm --filter comanda exec node ../mesa/scripts/generate-pwa-icons.mjs
//
// Outputs:
...
// Maskable: el contenido debe caber en el centro 80% (safe area). Expando el
// viewBox para que Android pueda recortar en cualquier forma sin comer la letra.
