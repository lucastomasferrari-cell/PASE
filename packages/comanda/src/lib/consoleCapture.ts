...
// para incluirlos automáticamente en los tickets de soporte (mismo archivo
// que packages/pase/src/lib/consoleCapture.ts, copia idéntica para evitar
// dependencia cross-package).
...
export function initConsoleCapture(): void {
  ...
  console.error = (...args: unknown[]) => {
    try {
      ...
      // No romper console.error si el captura falla
    }
