...
const TRADUCCIONES: Record<string, string> = {
  ...
  SIN_AUTORIZACION: 'No tenés permiso para esta acción. Pedí que un manager la autorice.',
  AUTORIZACION_REQUERIDA: 'Falta autorización para esta acción.',
  AUTORIZACION_REQUERIDA_DESCUENTO_GRANDE: 'Este descuento supera el límite. Pedí autorización o indicá el motivo si tenés permiso.',
  ...
  CUPO_TURNO_COMPLETO: 'Ese turno ya está completo (se llenó el cupo).',
