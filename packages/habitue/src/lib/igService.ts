// igService — bot de Instagram, traído a Habitué. Lee/escribe las tablas
// ig_* del mismo Supabase. Los mensajes salen vía el endpoint /api/send del
// backend del bot (deployado aparte en pase-instagram-bot.vercel.app — Meta
// apunta su webhook ahí). Configurable por env: VITE_IG_BOT_URL.
