export const ROLES: Record<string, { label: string; color: string; permisos: string[] }> = {
  dueno:   { label:"Dueño",    color:"#E8C547", permisos:["dashboard","ventas","compras","remitos","gastos","caja","caja_efectivo","eerr","contador","proveedores","empleados","config","maxirest","insumos","lector_ia","recetas","mp"] },
