...
export function Sidebar({ user, section, onNav, onLogout, locales, localActivo, setLocalActivo }) {
  ...
  const nav = [
    ...
    {id:"cashflow",label:"Cashflow",sec:"Finanzas",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="1,10 4,6 7,8 10,4 13,7"/><line x1="1" y1="13" x2="13" y2="13"/></svg>`},
    {id:"cierre",label:"Cierre",sec:"Finanzas",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="7" width="3" height="5"/><rect x="6" y="4" width="3" height="8"/><rect x="10" y="2" width="2" height="10"/></svg>`},
    ...
    {id:"blindaje",label:"Blindaje",sec:"Blindaje",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M7 1L2 3v4c0 3 2.5 5.5 5 6 2.5-.5 5-3 5-6V3L7 1z"/><polyline points="4.5,7 6.5,9 9.5,5.5"/></svg>`},
    ...
    {id:"configuracion",label:"Configuración",sec:"Config",icon:`<svg width="13" height="13" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="7" cy="7" r="2.5"/><path d="M7 1v1M7 12v1M1 7h1M12 7h1M2.9 2.9l.7.7M10.4 10.4l.7.7M2.9 11.1l.7-.7M10.4 3.6l.7-.7"/></svg>`},
  ];
...
.eerr-section-title{padding:10px 16px;font-size:9px;letter-spacing:.8px;text-transform:uppercase;color:var(--muted2);font-weight:500;border-top:1px solid var(--bd);background:var(--s1)}
