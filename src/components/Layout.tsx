...
export function Sidebar({ user, section, onNav, onLogout, locales, localActivo, setLocalActivo }) {
  ...
  const nav = [
    ...
    {id:"costos",label:"Costos",icon:"📋",sec:"Operaciones"},
...
:root{--bg:#0f1117;--s1:#161b27;--s2:#1c2333;--s3:#242d3d;--bd:#2d3548;--bd2:#3d4a5c;--acc:#6366f1;--acc2:#f97316;--acc3:#06b6d4;--txt:#e2e8f0;--muted:#94a3b8;--muted2:#64748b;--danger:#f87171;--success:#34d399;--warn:#fbbf24;--info:#60a5fa;--r:8px}
...
.sb-name{font-family:'Inter',sans-serif;font-size:22px;font-weight:800;color:var(--acc);letter-spacing:1px;line-height:1}
...
.nav-item.active{background:rgba(99,102,241,0.1);color:var(--acc);border-left-color:var(--acc)}
...
.ph-title{font-family:'Inter',sans-serif;font-size:28px;font-weight:800;line-height:1}
...
.kpi{background:var(--s1);border:1px solid var(--bd);border-radius:var(--r);padding:16px;box-shadow:0 1px 3px rgba(0,0,0,.3)}
.kpi-label{font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-bottom:8px}
.kpi-value{font-family:'Inter',sans-serif;font-size:26px;font-weight:700;line-height:1}
...
.panel{background:var(--s1);border:1px solid var(--bd);border-radius:var(--r);margin-bottom:16px;box-shadow:0 1px 3px rgba(0,0,0,.3)}
...
.b-danger{background:rgba(248,113,113,.15);color:var(--danger)}.b-success{background:rgba(52,211,153,.15);color:var(--success)}.b-warn{background:rgba(251,191,36,.15);color:var(--warn)}.b-info{background:rgba(96,165,250,.15);color:var(--info)}.b-muted{background:var(--s3);color:var(--muted2)}.b-anulada{background:rgba(100,100,100,.12);color:var(--muted);text-decoration:line-through}
...
.btn-acc{background:var(--acc);color:#fff;border:none}.btn-acc:hover{background:#818cf8}
...
.caja-saldo{font-family:'Inter',sans-serif;font-size:20px;font-weight:700}
...
.login-bg{position:absolute;inset:0;background:radial-gradient(ellipse at 30% 40%,rgba(99,102,241,.08) 0%,transparent 60%)}
.login-card{position:relative;width:400px;background:var(--s1);border:1px solid var(--bd);border-radius:var(--r);padding:40px}
.login-brand{font-family:'Inter',sans-serif;font-size:36px;font-weight:800;color:var(--acc);line-height:1;letter-spacing:1px}
.login-sub{font-size:9px;letter-spacing:3px;text-transform:uppercase;color:var(--muted);margin-bottom:32px;margin-top:2px}
.num{font-family:'Inter',sans-serif;font-size:15px;font-weight:700}
